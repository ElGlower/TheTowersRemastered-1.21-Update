...
public class ModeSettingsGUI {
    ...
    public static void open(Player player) {
        ...
        // 1. Slot 10: Tiempo por Ronda de Votación
        ...
        gui.setItem(10, createActionItem(Material.CLOCK, ChatColor.GOLD + "" + ChatColor.BOLD + "⏱ " + TextUtil.toTiny("Ronda de Votación"), voteLore, "cycle_vote_secs"));

        // 2. Slot 12: Tiempo por Turno de Subasta
        ...
        turnLore.add(ChatColor.YELLOW + "» " + ChatColor.WHITE + TextUtil.toTiny("Clic: Ciclar (10s, 15s, 20s, 25s, 30s)"));
        ...
        // 3. Slot 14: Créditos Iniciales de Subasta
        ...
        credLore.add(ChatColor.YELLOW + "» " + ChatColor.WHITE + TextUtil.toTiny("Clic: Ciclar (50, 100, 150, 200, 250, 300)"));
        gui.setItem(14, createActionItem(Material.EMERALD, ChatColor.GREEN + "" + ChatColor.BOLD + "⚖ " + TextUtil.toTiny("Créditos de Subasta"), credLore, "cycle_credits"));

        // 4. Slot 16: Tiempo de Lectura de Reglas de Modo
        ...
        gui.setItem(16, createActionItem(Material.BOOK, ChatColor.LIGHT_PURPLE + "" + ChatColor.BOLD + "📖 " + TextUtil.toTiny("Tiempo de Lectura"), readLore, "cycle_read_secs"));
